...
MPREAL_PERMISSIVE_EXPR const int std::numeric_limits<mpfr::mpreal>::min_exponent10 = (int) (MPFR_EMIN_DEFAULT * 0.3010299956639811); 
MPREAL_PERMISSIVE_EXPR const int std::numeric_limits<mpfr::mpreal>::max_exponent10 = (int) (MPFR_EMAX_DEFAULT * 0.3010299956639811); 
#endif /* __MPREAL_H__ */
